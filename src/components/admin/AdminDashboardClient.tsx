...
export function AdminDashboardClient({ user, initialData: d }: { user: any; initialData: any & { siteSections: SiteSectionSetting[] } }) {
  ...
  const content = () => {
    ...
    if (tab === 'profile') return <div className="space-y-10"><AdminSingletonEditor title="Profile" description="Your professional identity, summary, contact details, availability, profile image and active CV." resource="profile" value={d.profile} fields={[
